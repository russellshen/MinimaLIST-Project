...
Unless otherwise noted, all files in this repository are covered by the license above.
If any subdirectory or file includes a different license header, that header governs for that file.
